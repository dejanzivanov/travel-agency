<template>
    <div>
        <admin-sidebar-component @component-click="setActiveComponent"></admin-sidebar-component>
...
<script>
import AdminSidebarComponent from './AdminSidebarComponent.vue';
