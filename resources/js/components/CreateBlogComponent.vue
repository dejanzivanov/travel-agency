    ...
    <div>
        <div class="container shaking-effect">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" v-model="this.title" :id="title" name="title" required>
            </div>
            <div class="mb-3">
                <label :for="description" class="form-label label-white">Description</label>
                <input type="text" class="form-control" v-model="this.description" :id="description" name="description" required>
            </div>
            <div class="mb-3">
                <label for="bodyText" class="form-label label-white">Body Text</label>
                <vue-editor id="bodyText" @input="logContent" v-model="this.content" :editorOptions="editorOptions"></vue-editor>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="type" :id="this.post" value="post" v-model="type">
                    <label class="form-check-label label-white" :for="this.post">
                        Post
                    </label>
                </div>
            </div>
            ...
            <div class="d-flex justify-content-center">
                <button class="btn btn-primary" v-on:click="updatePost()">Create Post</button>
            </div>
        </div>
